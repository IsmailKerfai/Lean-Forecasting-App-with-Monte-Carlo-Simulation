...
@Component({
  selector: 'app-cycle-feature',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './cycle-feature.component.html',
  styleUrl: './cycle-feature.component.css'
})
/*
Die Klasse CycleComponent beinhaltet alle Graphen für die Features und EingabeFunktionen
@Author Cihan Miro Mueller
@version 19.01.2025
*/
export class CycleFeatureComponent {
	...
	selectedButton: string = 'features';
	...
	SendDate(): void{
		if(this.startDate && this.endDate){
			...
			this.apiService.getSendDate_Features(formattedStartDate, formattedEndDate).subscribe(
				(response: number) => {
	...
	*/
	ngOnInit(): void {
		...
		this.apiService.getstartDate_Features().subscribe(
        (date: string[]) => {
    	...
    	this.apiService.getendDate_Features().subscribe(
        (date: string[]) => {
            if (date && date.length > 0) {
	...
	*/
	private initializeCharts(): void{
		this.createChart('Cycle_Day', this.xAchse_Cycle_Day, this.yAchse_Cycle_Day,'Features', this.Cycle_Day_85, this.Cycle_Day_50, 'Cycle Day - Features', false);
		this.createChart('Lead_Day', this.xAchse_Lead_Day, this.yAchse_Lead_Day,'Features', this.Lead_Day_85, this.Lead_Day_50, 'Lead Day - Features', false);
		this.createChart('Cycle_Efficiency', this.xAchse_Cycle_Efficiency, this.yAchse_Cycle_Efficiency,'Features', this.Cycle_Efficiency_85, this.Cycle_Efficiency_50, 'Cycle Efficiency - Features', true);
	}
	/**
	* Map zur Verwaltung aller aktuell erstellten Diagramme.
	*/
